...
<head>
	...
	<title> 
		Angel's Vehicle Registration Tool
	</title>
...
<div class="container">
	<form action="insertToDb.php" method="post">
		...
		<input type="number" step="0.01" name="vehicle_make" required><br>

		<label>Vehicle Model:</label>
		<input type="number" step="0.01" name="vehicle_model" required><br>
        
        <label>Empoloyee Name:</label>
		<input type="number" step="0.01" name="name_of_employee" required><br>
